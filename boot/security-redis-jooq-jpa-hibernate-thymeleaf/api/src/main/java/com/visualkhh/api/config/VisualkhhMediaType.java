...
public class VisualkhhMediaType extends MediaType{
	...
	public final static String VISUALKHH_V1_JSON_VALUE = "application/com.omnicns.visualkhh-v1+json";
	public final static MediaType VISUALKHH_V2_JSON;
	public final static String VISUALKHH_V2_JSON_VALUE = "application/com.omnicns.visualkhh-v2+json";
	static {
